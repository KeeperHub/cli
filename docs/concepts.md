...
The server communicates over stdin/stdout. When integrated with Claude Desktop, the host application manages the process lifecycle. See [quickstart.md](quickstart.md) for setup instructions.
